          ...
          <Table>
            <TableHeader className="bg-slate-50/50">
              <TableRow className="hover:bg-transparent border-slate-100">
                <TableHead className="font-bold text-slate-400 uppercase tracking-widest text-[10px] whitespace-nowrap">Project Name</TableHead>
                <TableHead className="font-bold text-slate-400 uppercase tracking-widest text-[10px] whitespace-nowrap hidden md:table-cell">Client</TableHead>
                <TableHead className="font-bold text-slate-400 uppercase tracking-widest text-[10px] whitespace-nowrap">Status</TableHead>
                <TableHead className="font-bold text-slate-400 uppercase tracking-widest text-[10px] whitespace-nowrap hidden sm:table-cell">Assigned To</TableHead>
                <TableHead className="font-bold text-slate-400 uppercase tracking-widest text-[10px] whitespace-nowrap hidden lg:table-cell">Deadline</TableHead>
                <TableHead className="font-bold text-slate-400 uppercase tracking-widest text-[10px] whitespace-nowrap">Progress</TableHead>
                    ...
                    <TableCell className="hidden sm:table-cell">
                      <div className="flex items-center gap-2 whitespace-nowrap">
                        <Avatar className="h-6 w-6 border border-slate-200">
                          <AvatarImage src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${project.assigned_to || 'default'}`} />
                          <AvatarFallback>{project.assigned_to?.charAt(0) || '?'}</AvatarFallback>
                        </Avatar>
                        <span className="text-sm font-semibold text-slate-700">{project.assigned_to || 'Unassigned'}</span>
                      </div>
                    </TableCell>
